...
#ifdef GBSP_PSRAM
#define obj_priority_list   gbsp_memory->obj_priority_list
#define obj_priority_count  gbsp_memory->obj_priority_count
#define obj_alpha_count     gbsp_memory->obj_alpha_count
#else
