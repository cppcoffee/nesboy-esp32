...
static void netpacket_send(uint16_t client_id, const void *buf, size_t len)
{
   (void)client_id; (void)buf; (void)len;   // No network link on this device
}
static void netpacket_poll_receive(void)
{
}
